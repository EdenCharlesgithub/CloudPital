...
def disease_predict():
    ...
    # Get the recommended medicine for the predicted disease
    drug = drugprediction.recommend_medicine(str(disease))  # Ensure it's a string
    
    return render_template('disease_predict.html', disease=disease, drug=drug)
